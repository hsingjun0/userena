...
class userSeqTask(models.Model):
    """
    user manager their sequencing data/task here
    """
    user = models.CharField(max_length=20)
    jodID = models.CharField(max_length=20)
    seqFile = models.CharField(max_length=120)
    seqAct = models.CharField(max_length=20)
    taskSta = models.CharField(max_length=20)
    resultAct = models.CharField(max_length=10)
